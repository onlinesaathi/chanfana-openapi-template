...
var productSchema = external_exports.object({
  ...
  description: external_exports.string().optional().describe("Product description"),
  price: external_exports.number().describe("Product price"),
  stock: external_exports.number().describe("Product stock quantity"),
  image_url: external_exports.string().optional().describe("Product image URL")
});
var ListProducts = class extends OpenAPIRoute {
  static {
    __name(this, "ListProducts");
  }
  schema = {
    tags: ["Admin Products"],
...
var CreateProduct = class extends OpenAPIRoute {
  static {
    __name(this, "CreateProduct");
  }
  schema = {
    tags: ["Admin Products"],
...
var UpdateProduct = class extends OpenAPIRoute {
  static {
    __name(this, "UpdateProduct");
  }
  schema = {
    tags: ["Admin Products"],
  ...
  async handle(c) {
    ...
    if (!parsed.success) return c.json({ error: "Invalid data" }, 400);
    const db = c.env.DB;
    const fields = Object.entries(parsed.data).filter(([_, v]) => v !== void 0);
...
var DeleteProduct = class extends OpenAPIRoute {
  static {
    __name(this, "DeleteProduct");
  }
  schema = {
    tags: ["Admin Products"],
...
// src/endpoints/admin/orders.ts
var ListOrders = class extends OpenAPIRoute {
  static {
    __name(this, "ListOrders");
  }
  schema = {
    tags: ["Admin Orders"],
...
var DeleteOrder = class extends OpenAPIRoute {
  static {
    __name(this, "DeleteOrder");
  }
  schema = {
    tags: ["Admin Orders"],
...
var ListUsers = class extends OpenAPIRoute {
  static {
    __name(this, "ListUsers");
  }
  schema = {
    tags: ["Admin Users"],
...
var DeleteUser = class extends OpenAPIRoute {
  static {
    __name(this, "DeleteUser");
  }
  schema = {
    tags: ["Admin Users"],
...
var registerSchema = external_exports.object({
  name: external_exports.string().describe("User name"),
  email: external_exports.string().email().describe("User email"),
  password: external_exports.string().min(6).describe("User password")
});
var Register = class extends OpenAPIRoute {
  static {
    __name(this, "Register");
  }
  schema = {
    tags: ["Auth"],
...
var loginSchema = external_exports.object({
  email: external_exports.string().email().describe("User email"),
  password: external_exports.string().describe("User password")
});
...
// .wrangler/tmp/bundle-nTlcg2/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-nTlcg2/middleware-loader.entry.ts
